              ...
              <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                  ...
                  <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                      ...
                      @else
                          ...
                          <a href="{{ route('login') }}" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Đăng nhập</a>
                  ...
                  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li> <a href="{{ route('guest.index') }}" class="block py-2 px-3 rounded md:p-0 {{ request()->routeIs('guest.index') ? 'text-white bg-blue-700 md:bg-transparent md:text-blue-700 md:dark:text-blue-500' : 'text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 dark:text-white dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700' }}" aria-current="{{ request()->routeIs('guest.index') ? 'page' : 'false' }}">Trang chủ</a> </li>
                        ...
                        @auth @if(Auth::user()->role === 'Admin') <li> <a href="{{ route('dashboard') }}" class="block py-2 px-3 rounded md:p-0 {{ (request()->routeIs('dashboard') || request()->routeIs('posts.list') || request()->routeIs('categories.*')) ? 'text-white bg-blue-700 md:bg-transparent md:text-blue-700 md:dark:text-blue-500' : 'text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 dark:text-white dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700' }}" aria-current="{{ (request()->routeIs('dashboard') || request()->routeIs('posts.list') || request()->routeIs('categories.*')) ? 'page' : 'false' }}">Quản lý</a> </li> @endif @endauth
                    </ul>
                  </div>
              </div>
            </nav>
